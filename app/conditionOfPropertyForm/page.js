...
const ConditionOfPropertyForm = () => {
    ...
    return (
        <form action={createTask}>
            <h2 className="text-center font-extrabold mb-2">What is the Condition of the Property?</h2>
            <div className="flex flex-col w-full mb-8">
                <Link href="/ownedPropertyForm">
...
export default ConditionOfPropertyForm;